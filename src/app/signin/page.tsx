      ...
      <div style={{ width: '100%', maxWidth: '440px' }}>
        ...
        <div className="card-arabic" style={{ padding: '2.5rem' }}>
          ...
          <form onSubmit={handleSubmit} style={{ display: 'flex', flexDirection: 'column', gap: '1.1rem' }}>
            ...
            <div>
              <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginBottom: '0.4rem' }}>
                ...
                <Link href="/forgot-password" style={{ fontFamily: 'var(--font-body)', fontSize: '0.75rem', color: 'var(--color-terra)', textDecoration: 'none' }}>
                  Forgot password?
                </Link>
              </div>
              <input
          ...
          <p style={{ fontFamily: 'var(--font-body)', fontSize: '0.8rem', color: 'var(--color-espresso-lt)', textAlign: 'center', marginTop: '1.75rem' }}>
            ...
            <Link href="/register" style={{ color: 'var(--color-terra)', textDecoration: 'none', fontWeight: 600 }}>
              Create one
            </Link>
          </p>
        </div>
